...
namespace Back_Atletica.Migrations
{
    ...
    [Migration("20201109221153_Logica-Grafos")]
    partial class LogicaGrafos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Back_Atletica.Models.AtleticaModalidadeAgendaTreino", b =>
                {
                    b.Property<int>("AtleticaModalidadeAgendaTreinoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.HasKey("AtleticaModalidadeAgendaTreinoId");

                    b.HasIndex("AgendaTreinoId");

                    b.HasIndex("AtleticaModalidadeId");

                    b.ToTable("AtleticaModalidadeAgendaTreinos");
                });
            ...
            modelBuilder.Entity("Back_Atletica.Models.AtleticaModalidadeAgendaTreino", b =>
                {
                    b.HasOne("Back_Atletica.Models.AgendaTreino", "AgendaTreino")
                        .WithMany("AtleticaModalidadeAgendaTreinos")
                        .HasForeignKey("AgendaTreinoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
